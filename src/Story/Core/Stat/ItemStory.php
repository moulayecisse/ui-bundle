...
namespace Cisse\Bundle\Ui\Story\Core\Stat;
...
#[AsComponentStory(
    ...
    category: 'core',
    label: 'Stat Item',
    description: 'Individual stat display with icon, value, trend, and customization options'
)]
class ItemStory extends AbstractComponentStory
{
    ...
    public function withChangeIndicator(): StoryExample
    {
        return StoryExample::create()->preview(<<<'TWIG'
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
    ...
    public function withPrefixSuffix(): StoryExample
    {
        return StoryExample::create()->preview(<<<'TWIG'
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
